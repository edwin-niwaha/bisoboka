...
<div class='col-lg-6'>
    <div class='form-group'>
    <div><label>Loan Amount</label></div><input required class='easyui-textbox form-control'  style="height:34px;width:100%;" id='amount'name='amount' /> 
    ...
    <div class='col-lg-6'>
<div class='form-group'>
<div><label>Loan Interest Rate</label></div><input required  class='easyui-textbox form-control'  style="height:34px;width:100%;" name='interest' 
 id='interest' /></div>
</div>

<div class='col-lg-6'>
<div class='form-group'>
<div><label>Repay Period</label></div><input required class='easyui-textbox form-control'  style="height:34px;width:100%;" name='repay' 
 id='repay' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Collateral</label></div><input required class='easyui-textbox form-control'  style="height:34px;width:100%;" name='security' 
 id='security' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guaranter</label></div><input required  class='easyui-textbox form-control'  style="height:34px;width:100%;" name='guaranter' 
 id='guaranter' /></div>
...
<table class='easyui-datagrid' title='Loan Disbursement' iconCls='fa fa-table' singleSelect='true' url='viewsuppliers' pagination='true' id='gridsuppliers' method='get' fitColumns='true'  rownumbers='true' style='width:100%' toolbar='#supplierstoolbar'>
<thead><tr>

<th field='date' width='90'>Dates</th>
<th field='name' width='50'>Name</th>
<th field='loancredit' width='50'>LoanAmount</th>
<th field='paydet' width='50'>Payment Details</th>
...
<th field='loanid' width='150'>Loanid</th>
...
url:url,
method:'POST',
data:{'id':id,'name':name,'paydet':paydet,'branch':branch,'security':security,'interest':interest,'date':date,'repay':repay,'gauranter':gauranter,'created_at':created_at,'updated_at':updated_at,'amount':amount,'_token':$('input[name=_token]').val()},

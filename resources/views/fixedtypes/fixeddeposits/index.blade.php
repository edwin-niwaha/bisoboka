...
<div><label>Name</label></div><input style="height:34px;width:100%"  class='easyui-combobox form-control' data-options="url:'customerscombo',method:'get',valueField:'id',textField:'name'"  name='client_id' id='client_id' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Date</label></div><input style="height:34px;width:100%" type='text' data-options="onSelect:validateDate" class='easyui-datebox form-control' name='fixdate' 
 id='fixdate' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Amount</label></div><input  style="height:34px;width:100%" type='text' class='easyui-textbox form-control' name='fixamount' 
 id='fixamount' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Interest Rate</label></div><input style="height:34px;width:100%"  type='text' class='easyui-textbox form-control' name='fixinterest' 
 id='fixinterest' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Period (months)</label></div><input  style="height:34px;width:100%" type='text' class='easyui-textbox form-control' name='fixperiod' 
 id='fixperiod' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Mode</label></div><input  style="height:34px;width:100%" type='text' class='easyui-combobox form-control' name='mode' 
 id='mode' data-options="url:'combofixedtypes',method:'get',valueField:'mode',textField:'name'" /></div>
</div>
</div>
...
<table class='easyui-datagrid' striped='true' rowNumbers='true' title='Fixed Deposits' iconCls='fa fa-table' singleSelect='true' url='viewfixeddeposits' pagination='true' id='gridfixeddeposits' method='get' fitColumns='true' style='width:100%' toolbar='#fixeddepositstoolbar'>
<thead><tr>
...
<th field='fixperiod' width='50'>Period</th>
...
url:url,
method:'POST',
data:{'id':id,'client_id':client_id,'mode':mode,'fixdate':fixdate,'fixamount':fixamount,'fixinterest':fixinterest,'fixperiod':fixperiod,'maturitydate':maturitydate,'maturityinterest':maturityinterest,'created_at':created_at,'updated_at':updated_at,'_token':$('input[name=_token]').val()},
success:function(){

...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Payment Details</label></div><input   required style="height:34px;width:100%" class='easyui-textbox form-control' name='paydet' 
 id='paydet' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
...
<table   showFooter="true" rowNumbers="true" class='easyui-datagrid' title='Loan Repayments' iconCls='fa fa-table' singleSelect='true' url='viewcompanynames' pagination='true' id='gridcompanynames' method='get' fitColumns='true' style='width:100%' toolbar='#companynamestoolbar'>
<thead><tr>
<th field='loanid' width='100' >id</th>
...
<a href='javascript:void(0)' class='easyui-linkbutton' id='deletecompanynames' iconCls='icon-remove' > Delete</a>
<label>Date</label>
...
url:url,
method:'POST',
data:{'date':date,'memid':memid,'loanid':loanid,'name':name,'amount':amount,'paymentdetails':paymentdetails,'created_at':created_at,'updatated_at':updatated_at,'_token':$('input[name=_token]').val()},
    ...
    if(a==null){
        ...
        $.messager.confirm('Confirm','Are you sure you want to Delete this Record',function(r){
            if(r){
                var row=$('#gridcompanynames').datagrid('getSelected');
                $.ajax({
                 url:'/destroycompanynames/'+row.paydet,
                 method:'POST',

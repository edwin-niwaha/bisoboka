...
<table class='easyui-datagrid' title='Outstandings Report' iconCls='fa fa-table' singleSelect='true' showFooter="true" url='' pagination='true' id='gridpaynow' method='get' fitColumns='true' style='width:100%' toolbar='#customerstoolbar'>
    <thead><tr>
    <th field='transdate' width='100'>Duedate</th>
    <th field="purchaseheaderid" width='100'>headerno</th>
    <th field='name' width='150'>Customer</th>
    <th field='itemcode' width='100'>Itemname</th>
    <!--<th field='stockid' width='100'>ID</th>-->
...
// Financial Period
  ...
  $.ajax({
    ...
    $('#gridpaynow').datagrid({
method:'get',
url:'outstandingcusto?end='+finend+'&start='+finstart,
...
//Loaind Default Inventory Account

...
<div class='col-lg-6'>
    <div class='form-group'>
    <div><label>Loan Amount</label></div><input required class='easyui-numberbox form-control'  style="height:34px;width:100%;" id='amount'name='loancredit' /> 
...
<table class='easyui-datagrid' showFooter="true" title='Loan Disbursement' iconCls='fa fa-table' singleSelect='true' url='viewsuppliers' pagination='true' id='gridsuppliers' method='get' fitColumns='true'  rownumbers='true' style='width:100%' toolbar='#supplierstoolbar'>
<thead><tr>
    ...
    if(a==null){
        ...
        $.messager.confirm('Confirm','Are you sure you want to Delete this Record',function(r){
            if(r){
                var row=$('#gridsuppliers').datagrid('getSelected');
                $.ajax({
                 url:'/destroysuppliers/'+row.loanid,
                 method:'POST',

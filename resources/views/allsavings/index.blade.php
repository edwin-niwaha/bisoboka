...
success:function(data){
    if(data.isExists=='yes'){
        $.messager.alert({title:'Warning',icon:'warning',msg:'Reciept Number already exists, Please change and try again... '});
    }else{
...
method:'get',
queryParams:{date1:date1,date2:date2,reciept:reciept}

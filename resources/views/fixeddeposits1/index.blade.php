...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Term</label></div><input style="height:34px;width:100%"  class='easyui-combobox form-control'  name='term' id='term' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Interest Rate</label></div><input style="height:34px;width:100%"  type='text' class='easyui-numberbox form-control' name='fixinterest' 
 id='fixinterest' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Period (months)</label></div><input  style="height:34px;width:100%"  class='easyui-numberbox form-control' name='fixperiod' 
 id='fixperiod' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
